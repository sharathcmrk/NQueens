...
runtime = input("Please enter How many times you want to Run: ")                   #How may times you want to Run
runtime= int(runtime)

Board.set_size(board_size)
def generate_initial_state():
    '''We generate state at each column a queen is placed at a random row'''
    state= []
